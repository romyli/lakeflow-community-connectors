...
def test_microsoft_teams_connector():
    """Test the Microsoft Teams connector using the shared LakeflowConnect test suite."""
    # Inject the Microsoft Teams LakeflowConnect class into the shared test_suite namespace
    test_suite.LakeflowConnect = MicrosoftTeamsLakeflowConnect
